...
export const fetchRoutes = (fromPeriod: string, toPeriod: string, carNumber: string) => async (dispatch: Dispatch) => {
    const response = await axios.get<IRouteUnit>('https://mapon.com/api/v1/route/list.json', {
        params: {
